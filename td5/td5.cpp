...
int main()
{
    ...
    for (shared_ptr< Acteur > acteur :
         dynamic_cast< Film* >(bibliotheque[0])->acteurs_)
    {
        cout << *acteur << "\n";
    }
    ...
    copy_if(bibliotheque.begin(),
            bibliotheque.end(),
            back_inserter(bibliothequeFilms),
            [](Item* item)
            {
    ...
    cout << transform_reduce(bibliothequeFilms.begin(),
                             bibliothequeFilms.end(),
                             0,
                             plus< int >(),
                             [](Item* item)
                             {
                                 return dynamic_cast< Film* >(item)->recette_;
                             });
