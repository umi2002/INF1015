...
const string Item::afficherBase() const
{
    string affichage = "Titre: " + titre_ + "\n";
    affichage        += "Année: " + to_string(annee_) + "\n";

    return affichage;
}

const string Item::afficher() const
{
    return "";
};
...
const string Film::afficher() const
{
    string affichage = "";
    affichage        += "Réalisateur: " + realisateur_ + "\n";
    affichage        += "Recette: " + to_string(recette_) + "M$" + "\n";

    affichage += "Acteurs: \n";
    for (int i : range(acteurs_.obtenirNElements()))
    {
        affichage += "  " + acteurs_[i]->nom + ", "
                   + to_string(acteurs_[i]->anneeNaissance) + " "
                   + acteurs_[i]->sexe + "\n";
    }
...
const string Livre::afficher() const
{
    string affichage = "";
    affichage        += "Auteur: " + auteur_ + "\n";
    affichage        += "Copies vendues: " + to_string(copiesVendus_) + "\n";
    affichage        += "Nombre de pages: " + to_string(nPages_) + "\n";
...
const string FilmLivre::afficher() const
{
    string affichage = "";
    affichage        += Film::afficher();
    affichage        += Livre::afficher();
    return affichage;
}

ostream& operator<<(ostream& os, const Item& item)
{
    os << item.Item::afficherBase() << item.afficher();
    return os;
}
...
int main()
{
    ...
    bibliotheque.push_back(new FilmLivre(
        *dynamic_cast< Film* >(bibliotheque[indiceHobbitFilm]),
        *dynamic_cast< Livre* >(bibliotheque[indiceHobbitLivre])));
