...
Film* lireFilm(istream& fichier, ListeFilms& listeFilms)
{
    ...
    film.acteurs     = ListeActeurs(lireUint8(
    ...
    {
        listeActeurs[i] = lireActeur(
            fichier, listeFilms);  //TODO: Placer l'acteur au bon endroit dans
                                   //les acteurs du film.
        //ListeFilms& filmsJoueDans = listeActeurs[i].joueDans;
        //filmsJoueDans.ajouterFilm(*ptrFilm); //TODO: Ajouter le film à la
        //liste des films dans lesquels l'acteur joue.
    }
