...
Film* ListeFilms::lireFilm(istream& fichier)
{
	...
	{
		elements[i] = lireActeur(fichier); //TODO: Placer l'acteur au bon endroit dans les acteurs du film.
		ListeFilms& filmsJoueDans = (*elements[i]).joueDans;
		ajouterFilm(*ptrFilm); //TODO: Ajouter le film à la liste des films dans lesquels l'acteur joue.
	}
