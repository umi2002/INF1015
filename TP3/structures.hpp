...
//	Film** elements = nullptr; // Pointeur vers un tableau de Film*, chaque Film*
//pointant vers un Film.
//};
...
private:
    ...
    unique_ptr< shared_ptr< T >[] > elements_ =
        make_unique< shared_ptr< T >[] >(
            capacite_);  //Pointeur vers un tableau de Acteur*, chaque Acteur*
...
struct Film
{
    ...
    string titre       = "",
           realisateur = "";  //Titre et nom du réalisateur (on suppose qu'il
                              //n'y a qu'un réalisateur).
    int anneeSortie = 0, recette = 0;  //Année de sortie et recette globale du
                                       //film en millions de dollars
