...
namespace iter
{
    namespace impl
    {
        ...
        using AccumulateFn =
            IterToolFnOptionalBindSecond< Accumulator, std::plus<> >;
    }
...
private:
    ...
    using AccumVal = std::remove_reference_t<
        std::invoke_result_t< AccumulateFunc,
...
public:
    ...
    public:
        ...
        Iterator& operator++()
        {
            ...
            {
                *acc_val_ =
                    std::invoke(*accumulate_func_, *acc_val_, *sub_iter_);
            }
            return *this;
        }
