...
private:
    ...
    friend ZippedLongest
    zip_longest_impl< TupleType, Is... >(TupleType&&,
...
public:
    ...
    public:
        ...
        Iterator(IterTuple< TupleTypeT >&& iters,
                 IterTuple< TupleTypeT >&& ends) :
        ...
        bool operator!=(const Iterator< T, TT, TU >& other) const
        {
            return (
                ...
                || (std::get< Is >(iters_) != std::get< Is >(other.iters_)));
        }
    ...
    Iterator< AsConst< TupleType >, const_iterator_tuple_type, ConstOptType >
    begin() const
    {
...
template< typename TupleType, std::size_t... Is >
iter::impl::ZippedLongest< TupleType, Is... >
iter::impl::zip_longest_impl(TupleType&& containers,
                             std::index_sequence< Is... >)
{
