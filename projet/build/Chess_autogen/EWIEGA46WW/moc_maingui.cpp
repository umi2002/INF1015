...
struct qt_meta_stringdata_CLASSMainGuiENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSMainGuiENDCLASS = QtMocHelpers::stringData(
    "MainGui",
    "squareSelected",
    "",
    "std::pair<int,int>",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSMainGuiENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSMainGuiENDCLASS_t qt_meta_stringdata_CLASSMainGuiENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMainGuiENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MainGui::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMainGuiENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMainGuiENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMainGuiENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *MainGui::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMainGuiENDCLASS.stringdata0))
