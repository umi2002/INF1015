...
namespace iter
{
    namespace impl
    {
        ...
        struct ReverseIteratorWrapperImplType< Container, false > :
            type_is<
                IteratorWrapperImpl< reverse_iterator_type< Container >,
                                     reverse_iterator_end_type< Container > > >
        { };

        template< typename Container >
        using ReverseIteratorWrapper = typename ReverseIteratorWrapperImplType<
            Container,
            std::is_same_v< impl::reverse_iterator_type< Container >,
                            impl::reverse_iterator_end_type< Container > > >::
            type;
