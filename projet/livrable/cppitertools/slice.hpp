...
private:
    ...
    private:
        ...
        constexpr FnPartial(DifferenceType start,
                            DifferenceType stop,
                            DifferenceType step) noexcept :
            start_ {start},
            stop_ {stop},
            step_ {step}
        { }
...
public:
    ...
    template< typename Container,
              typename DifferenceType,
              typename = std::enable_if_t< is_iterable< Container > > >
    iter::impl::Sliced< Container, DifferenceType >
    operator()(Container&& container, DifferenceType stop) const
    {
    ...
    constexpr FnPartial< DifferenceType >
    operator()(DifferenceType stop) const noexcept
    {
        return {0, stop, 1};
    }
    ...
    template< typename DifferenceType,
              typename = std::enable_if_t< !is_iterable< DifferenceType > > >
    constexpr FnPartial< DifferenceType >
    operator()(DifferenceType start,
               DifferenceType stop,
               DifferenceType step = 1) const noexcept
    {
