...
Q_CONSTINIT static const qt_meta_stringdata_MainGui_t qt_meta_stringdata_MainGui = {
    {
        ...
        QT_MOC_LITERAL(55, 18),  // "unHighlightSquares"
        QT_MOC_LITERAL(74, 16),  // "movePieceIfValid"
        QT_MOC_LITERAL(91, 15),  // "highlightSquare"
        QT_MOC_LITERAL(107, 19)   // "highlightValidMoves"
    },
    "MainGui",
    "squareSelected",
    "",
...
void MainGui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->unHighlightSquares(); break;
        case 2: _t->movePieceIfValid((*reinterpret_cast< std::add_pointer_t<std::pair<int,int>>>(_a[1]))); break;
        case 3: _t->highlightSquare((*reinterpret_cast< std::add_pointer_t<std::pair<int,int>>>(_a[1]))); break;
        case 4: _t->highlightValidMoves((*reinterpret_cast< std::add_pointer_t<std::pair<int,int>>>(_a[1]))); break;
        default: ;
        }
