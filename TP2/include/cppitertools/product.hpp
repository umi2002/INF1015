...
namespace iter
{
    namespace impl
    {
        ...
        template< typename TupleType, std::size_t... Is >
        Productor< TupleType, Is... >
        product_impl(TupleType&& containers, std::index_sequence< Is... >);
    }
}
...
{
    friend Productor
    iter::impl::product_impl< TupleType, Is... >(TupleType&&,
...
private:
    ...
    {
        IteratorData() = delete;
        static_assert(std::tuple_size< std::decay_t< IterTupType > >::value
                          == sizeof...(Is),
    ...
    public:
        ...
        template< std::size_t Idx >
        static bool
        get_and_increment_with_wraparound(IterTupType&       iters,
                                          const IterTupType& begin_iters,
                                          const IterTupType& end_iters)
        {
        ...
        using IncFunc = bool (*)(IterTupType&,
                                 const IterTupType&,
                                 const IterTupType&);
...
{
    template< typename TupleType, std::size_t... Is >
    Productor< TupleType, Is... > product_impl(TupleType&& containers,
                                               std::index_sequence< Is... >)
    {
...
namespace iter::impl
{
    ...
    decltype(auto) product_repeat(std::index_sequence< Is... >,
                                  Container&& container)
    {
...
namespace iter
{
    ...
    {
        return impl::product_repeat(std::make_index_sequence< N > {},
