...
//Version de la partie 1 du code avec une structure ListeFilms.
...
//	}
//
//	//TODO: Retourner un pointeur soit vers un acteur existant ou un nouvel acteur
//ayant les bonnes informations, selon si l'acteur existait déjà.  Pour fins de
//débogage, affichez les noms des acteurs crées; vous ne devriez pas voir le
//même nom d'acteur affiché deux fois pour la création.
//}
//
//Film* lireFilm(istream& fichier, ListeFilms& listeFilms)
//{
...
//	film.anneeSortie = lireUint16(fichier);
//	film.recette = lireUint16(fichier);
//	film.acteurs.nElements = lireUint8(fichier);  //NOTE: Vous avez le droit
//d'allouer d'un coup le tableau pour les acteurs, sans faire de réallocation
//comme pour ListeFilms.  Vous pouvez aussi copier-coller les fonctions
//d'allocation de ListeFilms ci-dessus dans des nouvelles fonctions et faire un
//remplacement de Film par Acteur, pour réutiliser cette réallocation.
//
//	Film* ptrFilm = new Film();
//	(*ptrFilm).titre = film.titre;
//	(*ptrFilm).realisateur = film.realisateur;
...
//	for (int i : range(capacite))
//	{
//		elements[i] = lireActeur(fichier, listeFilms); //TODO: Placer l'acteur au bon
//endroit dans les acteurs du film. 		ListeFilms& filmsJoueDans =
//(*elements[i]).joueDans; 		filmsJoueDans.ajouterFilm(*ptrFilm); //TODO: Ajouter
//le film à la liste des films dans lesquels l'acteur joue.
//	}
//	return ptrFilm; //TODO: Retourner le pointeur vers le nouveau film.
//}
//
...
//{
//	//TODO: Utiliser des caractères Unicode pour définir la ligne de séparation
//(différente des autres lignes de séparations dans ce progamme). 	static const
...
//}
//
//void afficherFilmographieActeur(const ListeFilms& listeFilms, const string&
//nomActeur)
//{
//	//TODO: Utiliser votre fonction pour trouver l'acteur (au lieu de le mettre à
//nullptr). 	const Acteur* acteur = listeFilms.trouverActeur(nomActeur); 	if
//(acteur == nullptr) 		cout << "Aucun acteur de ce nom" << endl; 	else
//		listeFilms.afficherListeFilms();
//}
//
//int main()
//{
//	bibliotheque_cours::activerCouleursAnsi();  // Permet sous Windows les "ANSI
//escape code" pour changer de couleurs
//https://en.wikipedia.org/wiki/ANSI_escape_code ; les consoles Linux/Mac les
//supportent normalement par défaut.
//
//	static const string ligneDeSeparation =
//"\n\033[35m════════════════════════════════════════\033[0m\n";
//
//	//TODO: Chaque TODO dans cette fonction devrait se faire en 1 ou 2 lignes, en
//appelant les fonctions écrites.
//
//	//TODO: La ligne suivante devrait lire le fichier binaire en allouant la
//mémoire nécessaire.  Devrait afficher les noms de 20 acteurs sans doublons
//(par l'affichage pour fins de débogage dans votre fonction lireActeur).
...
//	cout << ligneDeSeparation << "Le premier film de la liste est:" << endl;
//	//TODO: Afficher le premier film de la liste.  Devrait être Alien.
//	afficherFilm(*(listeFilms.films()[0]));
//
//	cout << ligneDeSeparation << "Les films sont:" << endl;
//	//TODO: Afficher la liste des films.  Il devrait y en avoir 7.
//	listeFilms.afficherListeFilms();
//
//	//TODO: Modifier l'année de naissance de Benedict Cumberbatch pour être 1976
//(elle était 0 dans les données lues du fichier).  Vous ne pouvez pas supposer
//l'ordre des films et des acteurs dans les listes, il faut y aller par son nom.
//	(*listeFilms.trouverActeur("Benedict Cumberbatch")).anneeNaissance = 1976;
//
//	cout << ligneDeSeparation << "Liste des films où Benedict Cumberbatch joue
//sont:" << endl;
//	//TODO: Afficher la liste des films où Benedict Cumberbatch joue.  Il devrait
//y avoir Le Hobbit et Le jeu de l'imitation.
//	afficherFilmographieActeur(listeFilms, "Benedict Cumberbatch");
//
//	//TODO: Détruire et enlever le premier film de la liste (Alien).  Ceci devrait
//"automatiquement" (par ce que font vos fonctions) détruire les acteurs Tom
//Skerritt et John Hurt, mais pas Sigourney Weaver puisqu'elle joue aussi dans
//Avatar. 	detruireFilm(*(listeFilms.films()[0]));
...
//
//	//TODO: Faire les appels qui manquent pour avoir 0% de lignes non exécutées
//dans le programme (aucune ligne rouge dans la couverture de code; c'est normal
//que les lignes de "new" et "delete" soient jaunes).  Vous avez aussi le droit
//d'effacer les lignes du programmes qui ne sont pas exécutée, si finalement
//vous pensez qu'elle ne sont pas utiles. 	afficherFilmographieActeur(listeFilms,
//"");
//
//	//TODO: Détruire tout avant de terminer le programme.  La bibliothèque de
//verification_allocation devrait afficher "Aucune fuite detectee." a la sortie
//du programme; il affichera "Fuite detectee:" avec la liste des blocs, s'il
//manque des delete. 	listeFilms.detruireListeFilms();
//}